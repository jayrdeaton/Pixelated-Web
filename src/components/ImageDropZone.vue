<template>
  <div class="h-full relative">
    <div
      class="h-full border-2 border-dashed rounded-xl cursor-pointer transition-colors flex flex-col"
    ...
    <button
      v-if="file"
      class="absolute bottom-2.5 right-2.5 bg-violet-500 hover:bg-violet-400 text-white rounded-full w-8 h-8 flex items-center justify-center shadow-lg transition-colors"
      title="Randomize"
