  ...
  <div class="flex flex-wrap gap-5 mb-6 items-start">
    <div class="w-full">
      <div class="flex items-center mb-1.5">
        ...
        <span class="inline-flex items-center gap-1 text-sm font-medium text-gray-500 dark:text-zinc-400 ml-auto">Output<TooltipInfo text="Format determines the file type. Background fills transparent areas and gaps between shapes." /></span>
      </div>
